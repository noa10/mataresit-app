-- Fix claim notification URLs to match app routing structure
-- The current URLs use /teams/{teamId}/claims/{claimId} but the app routing only supports /claims
-- Since ClaimsManagement page handles team context via useTeam hook, we can use simple /claims URLs
