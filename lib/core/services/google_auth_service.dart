...
class GoogleAuthService {
  ...
  static GoogleSignIn _getGoogleSignIn() {
    ...
    if (kIsWeb) {
      ...
      _googleSignIn = GoogleSignIn(
        clientId:
            '835461278848-85lf9ffh18kk22u1qm9bln7v8q64ku15.apps.googleusercontent.com',
      );
    } else if (Platform.isIOS) {
      // iOS configuration - uses iOS client ID and server client ID
      _googleSignIn = GoogleSignIn(
        clientId:
            '835461278848-elj0ll0vlcr9hv3d1b44iuu1a7otj9qo.apps.googleusercontent.com',
        serverClientId:
            '835461278848-85lf9ffh18kk22u1qm9bln7v8q64ku15.apps.googleusercontent.com',
      );
  ...
  static Future<void> signInWithGoogle() async {
    try {
      AppLogger.info(
        '🔐 Starting Google Sign-In for platform: ${_getPlatformName()}',
      );
