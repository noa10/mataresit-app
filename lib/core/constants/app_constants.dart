...
class AppConstants {
  ...
  static const String stripeProMonthlyPriceId = String.fromEnvironment(
    'STRIPE_PRO_MONTHLY_PRICE_ID',
    defaultValue: '',
  );
  static const String stripeProAnnualPriceId = String.fromEnvironment(
    'STRIPE_PRO_ANNUAL_PRICE_ID',
    defaultValue: '',
  );
  static const String stripeMaxMonthlyPriceId = String.fromEnvironment(
    'STRIPE_MAX_MONTHLY_PRICE_ID',
    defaultValue: '',
  );
  static const String stripeMaxAnnualPriceId = String.fromEnvironment(
  ...
  static const String receiptUploadSuccessMessage =
      'Receipt uploaded successfully!';
  static const String teamInviteSuccessMessage =
