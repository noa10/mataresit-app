...
void main() {
  group('ConfidenceUtils Tests', () {
    test('should correctly read confidence from ai_suggestions field', () {
      ...
      final confidence1 = ConfidenceUtils.calculateAggregateConfidence(receipt1);
      ...
      final confidence2 = ConfidenceUtils.calculateAggregateConfidence(receipt2);
      expect(confidence2, equals(85.0));
    });

    test('should fallback to confidence_scores when ai_suggestions.confidence is not available', () {
    ...
    test('should get correct confidence colors', () {
      expect(ConfidenceUtils.getConfidenceColor(95.0), equals(ConfidenceColor.high));
      expect(ConfidenceUtils.getConfidenceColor(70.0), equals(ConfidenceColor.medium));
      expect(ConfidenceUtils.getConfidenceColor(45.0), equals(ConfidenceColor.low));
    });
  });
}
