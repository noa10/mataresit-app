  ...
  group('iOS Performance Tests', () {
    ...
    group('Memory Management Tests', () {
      testWidgets('Memory Usage Monitoring', (WidgetTester tester) async {
        ...
        final initialMemoryData = await IOSPerformanceService.getCurrentMemoryUsage();
        final initialMemory = initialMemoryData['image_cache_size_bytes'] as int? ?? 0;
        logger.i('Initial memory usage: ${(initialMemory / 1024 / 1024).toStringAsFixed(2)}MB');
        ...
        final peakMemoryData = await IOSPerformanceService.getCurrentMemoryUsage();
        final peakMemory = peakMemoryData['image_cache_size_bytes'] as int? ?? 0;
        logger.i('Peak memory usage: ${(peakMemory / 1024 / 1024).toStringAsFixed(2)}MB');
        ...
        final finalMemoryData = await IOSPerformanceService.getCurrentMemoryUsage();
        final finalMemory = finalMemoryData['image_cache_size_bytes'] as int? ?? 0;
        logger.i('Final memory usage: ${(finalMemory / 1024 / 1024).toStringAsFixed(2)}MB');

        // Verify memory was properly managed
        expect(finalMemory, lessThan(peakMemory + (10 * 1024 * 1024)),
      ...
      testWidgets('Image Cache Management', (WidgetTester tester) async {
        ...
        expect(cacheSize, lessThanOrEqualTo(50),
    ...
    group('Performance Optimization Tests', () {
      ...
      testWidgets('Background Processing Performance', (WidgetTester tester) async {
    ...
    group('Battery Usage Tests', () {
      ...
      testWidgets('Battery-Aware Performance Tuning', (WidgetTester tester) async {
    ...
    group('Thermal Performance Tests', () {
      testWidgets('CPU Intensive Operations', (WidgetTester tester) async {
        ...
        logger.i('CPU intensive operation time: ${cpuTime}ms (result: $result)');
        
        // Verify CPU operations complete in reasonable time
        expect(cpuTime, lessThan(5000),
      ...
      testWidgets('Memory Allocation Performance', (WidgetTester tester) async {
        ...
        expect(allocTime, lessThan(1000),
    ...
    group('Performance Metrics Collection', () {
      ...
      testWidgets('Performance Monitoring Over Time', (WidgetTester tester) async {
        ...
        final monitoringResults = await IOSPerformanceService.stopPerformanceMonitoring();
        
        logger.i('Performance monitoring results: $monitoringResults');
        
        expect(monitoringResults, isNotEmpty,
    ...
    tearDownAll(() async {
      ...
      logger.i('Performance test logs exported: ${logData['totalEntries']} entries');
    });
  });
}
