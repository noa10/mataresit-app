  ...
  group('Feature Parity Validation Tests', () {
    ...
    group('Core Authentication Features', () {
      testWidgets('Authentication Screen Parity', (WidgetTester tester) async {
        ...
        if (find.byType(LoginScreen).evaluate().isEmpty) {
          ...
          logger.i(
            'App appears to be authenticated, testing authenticated state',
          );
        } else {
      ...
      testWidgets('Apple Sign-In Integration (iOS-specific)', (
        WidgetTester tester,
      ) async {
    ...
    group('Dashboard and Receipt Management', () {
      ...
      testWidgets('Receipt Details View Parity', (WidgetTester tester) async {
        ...
        logger.i(
          'Receipt details view structure validated (requires sample data)',
        );
      });
    });
    ...
    group('Team Collaboration Features', () {
      testWidgets('Team Management Parity', (WidgetTester tester) async {
        ...
        logger.i(
          'Team management features use same backend as React web version',
        );
    ...
    group('Settings and Configuration', () {
      ...
      testWidgets('Subscription Management Parity', (
        WidgetTester tester,
      ) async {
        ...
        logger.i(
          'Subscription management uses same Stripe integration as React web version',
        );
    ...
    group('Data Synchronization', () {
      ...
      testWidgets('Offline Sync Capabilities', (WidgetTester tester) async {
        ...
        logger.i(
          'iOS offline sync capabilities enhanced beyond React web version',
        );
      });
    });
    ...
    tearDownAll(() async {
      ...
      logger.i(
        'Feature parity test logs exported: ${logData['totalEntries']} entries',
      );
      ...
      logger.i(
        '🚀 iOS enhancements: Apple Sign-In, native sharing, offline sync',
      );
      logger.i(
        '🚀 iOS accessibility: VoiceOver, Dynamic Type, iOS-specific features',
      );
    });
  });
}
